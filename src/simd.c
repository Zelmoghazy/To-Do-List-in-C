...
// Swizzle with compile-time indices (use like: f32x4_swizzle(v, 0, 1, 2, 3))
...
static inline f32x8 f32x8_broadcast_lane(f32x8 v, int lane) {
    // lane must be 0-7
    switch(lane & 7) {
        case 0: return _mm256_permute_ps(v, 0x00);
        case 1: return _mm256_permute_ps(v, 0x55);
        case 2: return _mm256_permute_ps(v, 0xAA);
        case 3: return _mm256_permute_ps(v, 0xFF);
        case 4: return _mm256_permute2f128_ps(v, v, 0x11);
        case 5: return _mm256_permute2f128_ps(v, v, 0x11);
        case 6: return _mm256_permute2f128_ps(v, v, 0x11);
        case 7: return _mm256_permute2f128_ps(v, v, 0x11);
        default: return v;
    }
}
...
static inline f64x4 f64x4_broadcast_lane(f64x4 v, int lane) {
    // lane must be 0-3
    switch(lane & 3) {
        case 0: return _mm256_permute_pd(v, 0x0);
        case 1: return _mm256_permute_pd(v, 0xF);
        case 2: return _mm256_permute2f128_pd(v, v, 0x11);
        case 3: return _mm256_permute2f128_pd(v, v, 0x11);
        default: return v;
    }
}
